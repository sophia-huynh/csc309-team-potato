...
?><html>
    <head>
        <script src="mp_script.js"></script>
    ...
    <body>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="myForm">
           Project Name: <input type="text" name="pname" id="pname1" value="<?php echo $pname;?>" onblur="validate("pname", this.value)">
           <span class="error">* <?php echo $pnameErr;?></span>
           <br><br>
           Project Image URL: <input type="text" name="url" id="url1" value="<?php echo $url;?>" onblur="validate("url", this.value)">
           <span class="error"><?php echo $urlErr;?></span>
           <br><br>
           Project Description: <textarea name="descr" id="descr1" rows="5" cols="40" onblur="validate("descr", this.value)"><?php echo $descr;?></textarea>
           <span class="error">* <?php echo $descrErr;?></span>
           <br><br>
           Funding Goal: <input type="text" name="goal" id="goal1" value="<?php echo $goal;?>" onblur="validate("goal", this.value)">
           <span class="error">* <?php echo $goalErr;?></span>
           <br><br>
           Days Until Deadline: <input type="text" name="deadline" id="deadline1" value="<?php echo $deadline;?>" onblur="validate("deadline", this.value)">
