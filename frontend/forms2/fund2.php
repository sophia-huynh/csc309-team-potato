...
<html>
    ...
    <body>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]), "?pid=$pid&uid=$uid";?>" id="myForm">
           Funding: <input type="text" name="fund" id="fund1" value="<?php echo $fund;?>" onblur="validate("fund", this.value)">
