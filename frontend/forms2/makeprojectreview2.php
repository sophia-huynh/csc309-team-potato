...
<html>
    <head>
        ...
        <script src="mpr_script.js"></script>
    ...
    <body>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]), "?pid=$pid";?>" id="myForm">
           Review Description: <textarea name="review" rows="5" cols="40" id="review1" onblur="validate("review", this.value)"><?php echo $review;?></textarea>
